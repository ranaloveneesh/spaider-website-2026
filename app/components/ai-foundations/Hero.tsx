...
const V = {
    ...
    chip: {
        ...
        show: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.38, ease: EXPO } },
    },
    heading: {
    ...
    /** Cinematic: blur collapses as the dashboard lands */
    dashboard: {
...
export default function AIFoundationsHero() {
    ...
    return (
        ...
        >
            ...
            >
                Supercharge your everyday company knowledge work with AI. Make your internal
                and approved external knowledge sources AI-ready — securely, on your
                infrastructure.
            </motion.p>
