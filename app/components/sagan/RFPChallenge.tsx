...
export default function RfpChallenge() {
	...
	return (
		<section className="mx-auto mt-12 w-full min-w-0 sm:mt-16 md:mt-20 lg:mt-40">
			<h2 className="mb-6 font-outfit text-4xl font-medium tracking-tight text-foreground sm:mb-8 sm:text-5xl">
				The RFP Challenge
			</h2>
			<div className="flex flex-row justify-between gap-20">
				<Reveal variant="fade-left" threshold={0.25} className="max-w-md">
					<p className="mt-3 w-full text-xs leading-6 text-muted sm:mt-5 sm:text-sm sm:leading-7 lg:text-base lg:leading-7">Every year, space organizations handle hundreds of RFPs, each requiring significant time from specialized engineering teams.</p>
