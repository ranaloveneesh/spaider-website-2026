...
function MiniPill({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-border/40 bg-panel/40 px-3 py-2.5 shadow-sm">
      <span className="min-w-0 text-[14px] font-semibold text-foreground">
        {children}
      </span>
      {right ? (
        <span className="ml-3 flex shrink-0 items-center">{right}</span>
      ) : null}
    </div>
  );
}
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:gap-4 lg:grid-cols-12 lg:gap-4">
        <article className="relative isolate col-span-1 overflow-hidden rounded-2xl border border-border/40 bg-panel/40 p-4 md:col-span-6 md:p-5 lg:col-span-8 lg:rounded-[20px] lg:p-6 xl:p-7">
          ...
          <div className="relative z-10 text-foreground">
            ...
            <p className="mt-3 max-w-4xl text-xs leading-6 text-muted opacity-90 sm:mt-4 sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
        ...
        <article className="col-span-1 rounded-2xl border border-border/40 bg-panel/40 p-3 shadow-sm md:col-span-3 lg:col-span-4 lg:rounded-[20px]">
          ...
          <h4 className="mt-3 ml-1 text-sm font-semibold text-foreground sm:ml-2 sm:text-base lg:ml-4 lg:text-lg">
            Making your enterprise AI-ready, one step at a time.
          </h4>
        </article>

        <article className="col-span-1 rounded-2xl border border-border/40 bg-panel/40 p-3 shadow-sm md:col-span-3 lg:col-span-4 lg:rounded-[20px]">
          <h5 className="text-center text-sm font-semibold text-foreground sm:text-base lg:text-lg">
            Fully Private
          </h5>
            ...
            <div className="flex items-start justify-between gap-2 px-1 sm:gap-4 sm:px-2">
              {[
                ...
                >
                  ...
                  <span className="text-center text-[0.65rem] font-semibold leading-tight text-foreground sm:text-xs md:text-sm">
                    {i.label}
                  </span>
                </div>
              ))}
          ...
          <h6 className="mt-4 ml-0.5 text-sm font-semibold text-foreground sm:mt-5 sm:ml-1 sm:text-base lg:text-lg">
            Own your data &amp; IP
          </h6>
          <p className="mt-2 ml-0.5 text-xs leading-6 text-muted sm:ml-1 sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
        ...
        <article className="col-span-1 rounded-2xl border border-border/40 bg-panel/40 p-3 shadow-sm md:col-span-6 lg:col-span-4 lg:rounded-[20px]">
          <h5 className="text-sm font-semibold text-foreground sm:text-base lg:text-lg">
            Our Strength
          </h5>
              ...
              <MiniPill
                right={
                  <Image
                    ...
                    width={180}
                    height={180}
                    className="h-8 w-8 sm:h-[2.2rem] sm:w-[2.2rem] md:h-[2.6rem] md:w-[2.6rem]"
                  />
                }
              >
                Deep Aerospace DNA
              ...
              <MiniPill
                right={
                  <Image
                    ...
                    width={160}
                    height={160}
                    className="h-7 w-7 sm:h-8 sm:w-8 md:h-[2.6rem] md:w-[2.6rem]"
                  />
                }
              >
        ...
        <article className="col-span-1 rounded-2xl border border-border/40 bg-panel/40 p-3 shadow-sm md:col-span-6 lg:col-span-4 lg:rounded-[20px]">
          ...
          <h6 className="mt-4 ml-0.5 text-sm font-semibold text-foreground sm:mt-6 sm:ml-1 sm:text-base lg:text-lg">
            Flexible deployment
          </h6>
          <p className="mt-2 ml-0.5 text-xs leading-6 text-muted sm:ml-1 sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
