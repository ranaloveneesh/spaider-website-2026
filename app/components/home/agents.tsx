    ...
    content: (
      <div className="grid w-full grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 md:h-full">
        ...
        <div className="flex min-w-0 flex-col gap-y-1.5 sm:gap-y-2">
          <h2 className="m-0! mt-0 mb-0 font-manrope text-base font-semibold text-white sm:text-lg lg:text-xl">
            AI Foundations
          </h2>
          <p className="mt-0 text-xs leading-6 text-gray-200 sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
