      ...
      <div className="relative mx-auto w-full min-w-0 max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-9 lg:grid-cols-4 lg:gap-10">
          <div className="min-w-0 sm:col-span-2 lg:col-span-2">
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="font-montserrat text-xs font-semibold uppercase tracking-wide text-foreground sm:text-sm">
                  Spaider Space
                </p>
                <p className="text-xs leading-6 text-muted-foreground font-inter sm:text-sm sm:leading-7">
          ...
          <nav className="min-w-0" aria-label="Footer — Platform">
            <h2 className="m-0 font-montserrat text-xs font-semibold uppercase tracking-wide text-foreground sm:text-sm">
              Platform
            </h2>
            <ul className="mt-3 space-y-2 sm:mt-4 sm:space-y-2.5">
              <li>
                <Link
                  href="/our-tech"
                  className="text-xs leading-6 text-muted-foreground transition-colors font-inter hover:text-foreground sm:text-sm sm:leading-7 lg:text-base"
                >
                  Our Tech
                </Link>
              </li>
          ...
          <section
            className="min-w-0 sm:col-span-2 lg:row-start-2 lg:col-start-3 lg:col-span-2"
            aria-labelledby="footer-contact-heading"
          >
            <h2
              id="footer-contact-heading"
              className="m-0 font-montserrat text-xs font-semibold uppercase tracking-wide text-muted-foreground sm:text-sm"
            >
              CONTACT US
            </h2>
            <ul className="mt-3 flex list-none flex-wrap gap-4 p-0 sm:mt-4 sm:gap-6 md:gap-8">
              <li>
                <a
                  ...
                  className="flex min-h-10 min-w-10 items-center justify-center rounded-md text-foreground transition-opacity hover:opacity-90"
        ...
        <div className="mt-8 flex flex-col gap-2 border-t border-white/10 pt-5 text-center sm:mt-10 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:pt-6 sm:text-left">
          <p className="text-xs leading-6 text-muted-tertiary font-inter sm:text-sm sm:leading-7">
