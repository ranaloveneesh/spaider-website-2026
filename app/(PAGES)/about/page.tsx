  ...
  return (
    <div className="w-full min-w-0 space-y-8 pb-10 sm:space-y-10 sm:pb-12">
      ...
      <Reveal
        ...
        variant="fade-up"
        threshold={0.2}
        className="space-y-3 text-xs leading-6 text-muted-foreground font-inter sm:space-y-4 sm:text-sm sm:leading-7 lg:text-base lg:leading-7"
      >
        <p>
      ...
      <Reveal
        ...
        variant="fade-up"
        threshold={0.25}
        className="font-manrope text-base font-semibold tracking-tight text-foreground sm:text-lg lg:text-xl"
      >
        Our Team
      </Reveal>
