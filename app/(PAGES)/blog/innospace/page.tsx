	...
	return (
		<div className="w-screen min-w-0 pb-16 space-y-6 sm:pb-20 sm:space-y-8 md:pb-24 md:space-y-10 max-w-7xl mx-auto">
			...
			<Reveal
				variant="zoom"
				threshold={0.25}
				className="relative aspect-video w-full min-w-0 overflow-hidden rounded-xl border border-border-card sm:rounded-2xl md:aspect-21/9"
			>
				<Image
			...
			<div className="w-full">
				...
				>
					<h1 className="font-outfit text-2xl font-medium leading-tight tracking-tight text-foreground sm:text-3xl lg:text-4xl">
						We Secured 2nd Place at INNOspace Masters 2025 (And We&apos;re Just
						Getting Started)
					</h1>
				...
				<article className="mt-6 space-y-0 sm:mt-8">
					...
					<Section title="The Challenge: Reimagining Space Operations">
						...
						<p className="text-sm leading-7 text-muted sm:text-base sm:leading-8">
							...
							AI agents that reduce repetitive workload, cut operational
							friction, and unlock faster iteration across space and defense
							programs.
						</p>
					</Section>
					...
					<Section title="Sagan - The AI RFP Manager">
						...
						<p className="text-sm leading-7 text-muted sm:text-base sm:leading-8">
							<strong className="font-medium text-foreground">Sagan</strong> is
							an AI agent that acts as an RFP Manager. It drafts and updates
							proposals by combining public sources with internal knowledge
							bases, producing accurate, structured documents that evolve with
							your inputs.
						</p>
						...
						<p className="text-sm leading-7 text-muted sm:text-base sm:leading-8">
							Sagan integrates with enterprise collaboration and document
							systems so engineers can ask questions, request changes, and
							reference prior proposals without leaving the tools they already
							use.
						</p>
					</Section>
					...
					<Section title="Result: 2nd Place in the OHB Challenge">
						...
						<blockquote className="mt-4 rounded-xl border border-border-card bg-card p-4 sm:mt-6 sm:p-5 lg:p-6">
							<p className="font-outfit text-base font-medium leading-snug text-foreground sm:text-lg">
								&ldquo;Securing 2nd place at INNOspace Masters this early in our
								journey validates what we&apos;ve believed from day one - the
								aerospace industry is ready for AI agents that actually
								understand the work. This recognition fuels our commitment to
								push boundaries and bring intelligent automation to space
					...
					<Section title="What's Next">
						<p className="text-sm leading-7 text-muted sm:text-base sm:leading-8">
							...
							accelerating SPAIDER AI and expanding what agents like Sagan can
							do across mission operations.
						</p>
						<p className="text-sm leading-7 text-muted sm:text-base sm:leading-8">
							The sector is mid-transition. Our aim is simple: let teams focus
							on creativity and breakthrough engineering while agents take on
							the repetitive, time-consuming tasks - faster, safer, and with
							better context.
						</p>
					</Section>
...
function Section({ title, children }: { title: string; children: ReactNode }) {
	return (
		<Reveal
			...
			variant="fade-up"
			threshold={0.2}
			className="mt-8 space-y-3 border-t border-border pt-6 first:mt-0 first:border-t-0 first:pt-0 sm:mt-10 sm:space-y-4 sm:pt-8 md:mt-12 md:pt-10"
		>
			<h2 className="font-outfit text-lg font-medium tracking-tight text-foreground sm:text-xl md:text-2xl">
				{title}
			</h2>
...
function SubTitle({ children }: { children: ReactNode }) {
	return (
		<h3 className="mt-4 text-sm font-medium text-foreground first:mt-0 sm:mt-5 sm:text-base">
			{children}
		</h3>
	);
}
