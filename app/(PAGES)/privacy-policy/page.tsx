	...
	return (
		<div className="w-full min-w-0 space-y-8 pb-10 sm:space-y-10 sm:pb-12">
			<Reveal as="header" variant="fade-up" threshold={0.35} className="space-y-3 sm:space-y-4">
				<h1 className="font-montserrat text-xl font-semibold tracking-tight text-foreground sm:text-2xl lg:text-3xl">Privacy Policy</h1>
				<p className="text-xs text-muted font-inter sm:text-sm">Last updated: 2 April 2026</p>
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">1. Data controller</h2>
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">2. Personal data we process</h2>
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">3. Purposes and legal bases (GDPR)</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">4. Retention</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">5. Recipients and transfers</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">6. Security</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">8. Cookies</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
			...
			<Reveal as="section" variant="fade-up" threshold={0.2} className="space-y-2.5 sm:space-y-3">
				<h2 className="text-base font-semibold text-foreground sm:text-lg lg:text-xl">9. Changes</h2>
				<p className="text-xs leading-6 text-foreground font-inter sm:text-sm sm:leading-7 lg:text-base lg:leading-7">
